...
class AccountMockModel extends AccountEntity {
  ...
  static AccountMockModel? fromAccountEntity(AccountEntity? entity) {
    if (entity == null) return null;
    return AccountMockModel(
      id: entity.id,
  ...
  static List<AccountEntity>? fromAccountEntities(
    List<AccountEntity>? entities,
  ) {
    if (entities == null) return null;
    return List<AccountMockModel>.from(
      entities.map(AccountMockModel.fromAccountEntity),
    );
  }

  static AccountMockModel? fromMap(dynamic map) {
    if (map == null) return null;
    return AccountMockModel(
      id: map[idKey],
      accountNumber: map[accountNumberKey],
      accountName: map[accountNameKey],
      type: AccountTypeMockExt.fromString(map[typeKey])!,
  ...
  static AccountMockModel fromJson(String source) {
  ...
  static List<AccountMockModel>? fromListMap(dynamic data) {
    if (data == null) return null;
    return List<AccountMockModel>.from(
      data.map<AccountMockModel?>(AccountMockModel.fromMap),
    );
  }

  static List<Map<String, dynamic>>? toListMap(List<AccountMockModel>? data) {
    if (data == null) return null;
    return List.of(data.map((item) => item.toMap()));
  }

  static List<AccountMockModel> fromListJson(String source) {
    return fromListMap(jsonDecode(source))!;
  }

  static String toListJson(List<AccountMockModel> data) {
    return jsonEncode(toListMap(data));
  }
}

extension AccountTypeMockExt on AccountType {
