...
part 'operation_receive_logic_send_selected_card_controller.g.dart';
...
class OperationReceiveCardController extends _$OperationReceiveCardController {
  @override
  Stream<List<CreditCardEntity>> build() {
    ...
    return data.map((result) {
      return result.when(
        ok: (value) {
          final selectedCard = ref.read(operationReceiveSelectedCardProvider).value;
...
@Riverpod()
ValueNotifier<CreditCardEntity> operationReceiveSelectedCard(Ref ref) {
