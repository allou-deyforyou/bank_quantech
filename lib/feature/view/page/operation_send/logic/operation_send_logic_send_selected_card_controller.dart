...
part 'operation_send_logic_send_selected_card_controller.g.dart';
...
class OperationSendCardController extends _$OperationSendCardController {
  @override
  Stream<List<CreditCardEntity>> build() {
    ...
    return data.map((result) {
      return result.when(
        ok: (value) {
          final selectedCard = ref.read(operationSendSelectedCardProvider).value;
...
@Riverpod()
ValueNotifier<CreditCardEntity> operationSendSelectedCard(Ref ref) {
